...
class PulsarPublisher:
    ...
    Se encarga de publicar comandos desde el BFF hacia los servicios correspondientes.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            topics_mapping: Diccionario que mapea tipos de comandos a tópicos
    ...
    def _get_topic_for_command(self, command_type: str) -> str:
        """Determina el tópico para un tipo de comando"""
        if command_type in self.topics_mapping:
            return self.topics_mapping[command_type]

        # Fallback to default topic using the command type name
        return f"persistent://public/default/bff-{command_type.lower()}"
    ...
    async def publish_command(self, command_type: str, data: Dict[str, Any], correlation_id: str = None):
        """
        ...
        try:
            ...
            # Determinar el tópico para el comando
            topic = self._get_topic_for_command(command_type)
